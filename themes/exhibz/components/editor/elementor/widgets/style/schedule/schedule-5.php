                                 ...
                                 <?php foreach($multiple_speaker as $key => $value){ ?>
                                       ...
                                       <div class="speaker-content"> 
                                          <?php if(isset($value['attachment_id'])): ?>
                                             <img class="schedule-slot-speakers <?php echo esc_attr("speaker-img-".++$key); ?>" src="<?php echo wp_get_attachment_url($value["attachment_id"],'thumbnail'); ?>" title="<?php echo esc_attr($key==1?$speaker_one:$speaker_two); ?>" alt="<?php echo esc_attr("speaker-".$key); ?>">
                                          <?php endif; ?>
