...
<!-- header nav start-->
<header id="header" class="header header-transparent h-transparent2 nav-center <?php echo exhibz_option('header_nav_sticky_section','no')=="yes"?"navbar-fixed":''; ?> ">
	<div class="container">
		<div class="row">
			...
			<div class="align-self-center <?php echo esc_html($header_btn_show) == 'yes'?'col-lg-8':'col-lg-10'; ?>">
