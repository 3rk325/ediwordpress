...
class Exhibz_Recent_Post extends WP_Widget {
	...
	function __construct() {
		...
		$widget_opt = array(
			...
			'description'	 => esc_html__('Recent post with thumbnail','exhibz')
		);

		parent::__construct( 'xs-recent-post', esc_html__( 'Exhibz recent post', 'exhibz' ), $widget_opt );
	}
		...
		<div class="widget-posts">
				...
				while ( $loop->have_posts() ):
					...
					<div class="widget-post media">
						<?php
							...
							echo '<a href="'.get_the_permalink().'"><img src="' . esc_url( $img ) . '" alt="' . esc_attr__('thumb','exhibz') . '"></a>';
							?>
			...
			<?php else: ?>
				<div class="nopost_message">
					<p><?php echo esc_html__( 'No post avainable', 'exhibz' ) ?></p>';
				</div>
			<?php endif; ?>  
			</div>
		<?php
	...
	function form( $instance ) {
		if ( isset( $instance[ 'title' ] ) ) {
			...
			$title = esc_html__( 'Recent posts', 'exhibz' );
		}
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'number_of_posts' ) ); ?>"><?php esc_html_e( 'Number of posts:', 'exhibz' ); ?></label>
