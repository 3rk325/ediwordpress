...
class Exhibz_Twitter_Feed extends WP_Widget {
    ...
    function __construct() {
        $widget_opt = array(
            ...
            'description'	 => esc_html__('Exhibz twitter feed','exhibz')
        );

        parent::__construct( 'xs-twitter-feed', esc_html__( 'Exhibz twitter feed', 'exhibz' ), $widget_opt );
    }
    ...
    function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'username' ) ); ?>"><?php esc_html_e( 'Username:', 'exhibz' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'loading_text' ) ); ?>"><?php esc_html_e( 'Loading text:', 'exhibz' ); ?></label>
