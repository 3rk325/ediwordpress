...
class Exhibz_Footer_Address extends WP_Widget
{
    function __construct() {
        $widget_opt = array(
            ...
            'description'   => esc_html__('Exhibz footer address','exhibz')
        );
        
        parent::__construct('xs-footer-address', esc_html__('Exhibz footer address', 'exhibz'), $widget_opt);
    }
    ...
    function form($instance){
    	if(isset($instance['title'])){
            ...
            $title = esc_html__( 'Footer address', 'exhibz' );
        }
        if(isset($instance['message'])){
            $message = $instance['message'];
        }else{
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'message' )); ?>"><?php esc_html_e( 'Message' , 'exhibz' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'address' )); ?>"><?php esc_html_e( 'Address:' , 'exhibz' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'mobile' )); ?>"><?php esc_html_e( 'Mobile:' , 'exhibz' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'media_icon' )); ?>"><?php esc_html_e( 'Media icon:' , 'exhibz' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'map_icon' )); ?>"><?php esc_html_e( 'Map icon:' , 'exhibz' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'map_btn' )); ?>"><?php esc_html_e( 'Map button:' , 'exhibz' ); ?></label>
